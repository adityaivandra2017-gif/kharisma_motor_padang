...
@section('content')
    <div class="space-y-6">
        <div class="admin-section-card flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:justify-between sm:p-6">
            ...
            <a
                href="{{ route('pimpinan.laporan.eoq-rop.pdf', $printQuery) }}"
                target="_blank"
                rel="noopener"
        ...
        <div class="admin-table-card admin-table-card--dropdown-safe">
            <div class="admin-table-toolbar admin-table-toolbar--filters">
                <form method="GET" action="{{ route('pimpinan.laporan.eoq-rop') }}" class="flex flex-col gap-3 lg:flex-row lg:items-end">
                    <div class="flex-1">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        @if ($hasFilter)
                            <a
                                href="{{ route('pimpinan.laporan.eoq-rop') }}"
