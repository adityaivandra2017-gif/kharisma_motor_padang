...
>
    ...
    >
        <div class="bg-gradient-to-br from-slate-900 via-rose-950 to-rose-900 px-6 py-8 text-center sm:px-8">
            ...
            <h2 id="pimpinanLogoutModalTitle" class="mt-4 text-xl font-bold text-white sm:text-2xl">
                Konfirmasi Keluar
            </h2>
        ...
        <div class="space-y-3 px-6 py-5 sm:px-8 sm:py-6">
            <p class="text-center text-sm text-slate-600">
                Sesi Anda akan diakhiri. Anda perlu login kembali untuk mengakses panel pimpinan.
            </p>
            <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-center">
                <button
                    id="pimpinanLogoutCancel"
                    type="button"
...
<form id="pimpinanLogoutForm" action="{{ route('logout') }}" method="POST" class="hidden">
    @csrf
</form>
