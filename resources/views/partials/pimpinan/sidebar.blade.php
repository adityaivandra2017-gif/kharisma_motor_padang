@php
    ...
    $dashboardItem = collect($menu['items'])->firstWhere('route', 'pimpinan.dashboard');
...
>
    <div class="relative shrink-0 overflow-hidden border-b border-rose-100 bg-gradient-to-b from-white to-rose-50/40 px-3 pb-2.5 pt-2.5 sm:px-4">
        ...
        @include('partials.shared.sidebar-brand', ['dashboardRoute' => 'pimpinan.dashboard'])
    </div>

    <nav id="pimpinanSidebarNav" class="admin-sidebar-scroll flex-1 space-y-1 overflow-y-auto overscroll-contain px-3 py-3">
        <a
        ...
        @foreach ($menu['groups'] as $group)
            ...
            <div class="pt-1">
                <button
                    ...
                    aria-controls="pimpinan-submenu-{{ $group['id'] }}"
        ...
        <div class="pt-1">
            <button
                ...
                aria-controls="pimpinan-submenu-{{ $laporanGroup['id'] }}"
            ...
            <div
                id="pimpinan-submenu-{{ $laporanGroup['id'] }}"
