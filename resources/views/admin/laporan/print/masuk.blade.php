...
<body>
    ...
    <div class="print-page">
        ...
        <h2 class="report-title">Laporan Barang Masuk</h2>
            ...
            <tbody>
                @forelse ($barangMasuks as $index => $masuk)
                    <tr>
                        ...
                        <td>{{ $masuk->onderdil?->kode_onderdil ?? '-' }}</td>
                        <td class="text-left">{{ $masuk->onderdil?->nama_onderdil ?? '-' }}</td>
                        <td class="text-left">{{ $masuk->supplier?->nama_supplier ?? '-' }}</td>
                        <td>{{ number_format($masuk->jumlah, 0, ',', '.') }}</td>
                    </tr>
                @empty
                    <tr>
        ...
        <div class="ringkasan">
            ...
            <table>
                <tr>
                    <td>Total Transaksi Barang Masuk</td>
                    <td>{{ number_format($ringkasan['total_transaksi'], 0, ',', '.') }} transaksi</td>
                </tr>
                <tr>
                    <td>Total Unit Barang Masuk</td>
                    <td>{{ number_format($ringkasan['total_unit'], 0, ',', '.') }} unit</td>
                </tr>
                <tr>
                    <td>Total Supplier Aktif</td>
                    <td>{{ number_format($ringkasan['total_supplier_aktif'], 0, ',', '.') }} supplier</td>
                </tr>
            </table>
        </div>
